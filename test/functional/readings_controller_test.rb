...
class ReadingsControllerTest < ActionController::TestCase
  ...
  test "should create reading" do
    assert_difference('Reading.count') do
      post :create, reading: { date: @reading.date, liters: @reading.liters, measurement: @reading.measurement }
    end
  ...
  test "should update reading" do
    put :update, id: @reading, reading: { date: @reading.date, liters: @reading.liters, measurement: @reading.measurement }
    assert_redirected_to reading_path(assigns(:reading))
  end
